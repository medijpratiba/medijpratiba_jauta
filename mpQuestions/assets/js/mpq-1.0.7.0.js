...
jQuery(document).ready(function () {
        ...
        jQuery(".mest").click(function () {
            ...
            jQuery('.grid5x5-single[data-mpgridnr = ' + Math.floor(laukums - randomkaulins) + ']')
                .removeClass(class2ad)
                //.css( { 'background-image': "url(" + jQuery('.grid5x5-single[data-mpgridnr = ' + Math.floor(laukums - randomkaulins) + ']').data('bgimg') + ")" })
                ;

            jQuery('.grid5x5-single[data-mpgridnr = ' + Math.floor(laukums - randomkaulins) + '] .grid-mpquestion .mpquestion_btn').addClass('d-none');

            if (laukums > circusfield_max) {
                jQuery('.grid5x5-single[data-mpgridnr = ' + Math.floor(laukums_old) + ']')
                    .removeClass(class2ad)
                    //.css({ 'background-image': "url(" + jQuery('.grid5x5-single[data-mpgridnr = ' + Math.floor(laukums_old) + ']').data('bgimg') + ")" })
                    ;

                jQuery('.grid5x5-single[data-mpgridnr = ' + Math.floor(laukums_old) + '] .grid-mpquestion .mpquestion_btn').addClass('d-none');
            }
            jQuery('.grid5x5-single[data-mpgridnr = ' + laukums + ']').addClass(class2ad)
            //.css({ 'background-image': '' })
            .css({
                'background-image': "url(" + jQuery('.grid5x5-single[data-mpgridnr = ' + laukums + ']').data('bgimg') + ")"
            })
            ;
            jQuery('.grid5x5-single[data-mpgridnr = ' + laukums + '] .grid-mpquestion .mpquestion_btn').removeClass('d-none');
        ...
        jQuery(".nojauna").click(function () {
            ...
            jQuery('.grid5x5-single[data-mpgridnr = ' + laukums + ']')
                .removeClass(class2ad)
                .css({ 'background-image': '' })
                //.css({ 'background-image': "url(" + jQuery('.grid5x5-single[data-mpgridnr = ' + laukums + ']').data('bgimg') + ")" })
                ;

            jQuery('.grid5x5-single[data-mpgridnr = ' + laukums + '] .grid-mpquestion .mpquestion_btn').addClass('d-none');
